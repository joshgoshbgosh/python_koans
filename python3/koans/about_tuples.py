...
class AboutTuples(Koan):
    def test_creating_a_tuple(self):
        ...
        self.assertEqual(5, count_of_three[2])  #had to look for this one.  but i think  i understand after i saw the answer.
                                                #since tuples can't be changed it was 2 in the bracket so the next in order was 5.
    def test_tuples_are_immutable_so_item_assignment_is_not_possible(self):
        ...
        self.assertRegex(msg, "'tuple' object does not support item assignment")  #i h
    ...
    def test_tuples_can_be_embedded(self):
        lat = (37, 14, 6, 'N')
        lon = (115, 48, 40, 'W')  #had to look for this.  I got most of it but didn't quite get it right with commas
